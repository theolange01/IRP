...
class EMMTargetSampler(object):
    ...
    @staticmethod
    def sample_examples(src_box: List[BoxList], pair_box: List[BoxList],
                        tar_box: List[BoxList], num_samples):
        """
        Sample examples
        """
    ...
    def generate_neg_examples(self, proposals: List[BoxList], gts: List[BoxList], pos_hn_boxes: List[BoxList]):
        """
    ...
    def __call__(self, proposals: List[BoxList], gts: List[BoxList]):
